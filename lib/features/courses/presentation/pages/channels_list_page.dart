...
class ChannelsListPage extends StatelessWidget {
  ...
  Widget _buildPlaylistCard(BuildContext context, 
      {required int playlistIndex, required String playlistId}) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(
          // ✅ تم التصحيح لتوافق نسخة فلاتر 2026
        ...
        trailing: Container(
          ...
          child: const Icon(Icons.play_arrow_rounded, color: Color(0xFF1976D2), size: 24),
        ),
        onTap: () {
          Navigator.push(
            context,
